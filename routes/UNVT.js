...
const UNmbtilesDir = config.get('UNmbtilesDir')
...
const getMBTiles = async (t, z, x, y) => {
  ...
  if (z < tz[t]) {
    if (sTileName[t]) {
      ...
      mbtilesPath = `${UNmbtilesDir}/${t}/${stname}.mbtiles`
      mbtilesPath2 = `${UNmbtilesDir}/${t}/${stname}.mbtiles`
      mbtilesPath3 = `${UNmbtilesDir}/${t}/${stname}.mbtiles`
      } else {
      mbtilesPath = `${UNmbtilesDir}/${t}/0-0-0.mbtiles`
      mbtilesPath2 = `${UNmbtilesDir}/${t}/0-0-0.mbtiles`
      mbtilesPath3 = `${UNmbtilesDir}/${t}/0-0-0.mbtiles`
      }
  } else {
    mbtilesPath =
      `${UNmbtilesDir}/${t}/${tz[t]}-${x >> (z - tz[t])}-${y >> (z - tz[t])}.mbtiles`
    mbtilesPath2 =
      `${UNmbtilesDir}/${t}/${tz2}-${x >> (z - tz2)}-${y >> (z - tz2)}.mbtiles`     
    mbtilesPath3 =
      `${UNmbtilesDir}/${t}/${tz3}-${x >> (z - tz3)}-${y >> (z - tz3)}.mbtiles`        
  }
